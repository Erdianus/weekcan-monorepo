export default function Page() {
  return (
    <div className="container prose prose-slate mx-2 mt-2 py-5 dark:prose-invert lg:prose-xl sm:mx-auto">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to HK Group, Anggrek Merpati St..
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to weekcan, accessible from{" "}
            <a
              href="https://weekcan.hktekno.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://weekcan.hktekno.com
            </a>
          </p>
        </li>
        <li>
