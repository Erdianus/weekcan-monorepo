      ...
      <main className="flex-1">
        ...
        >
          <div className="flex w-full flex-col bg-background">
            <section className="fade-bottom overflow-hidden bg-background px-4 py-12 pb-0 text-foreground sm:py-24 sm:pb-0 md:py-32 md:pb-0">
...
export async function Pag() {
  ...
  return (
    <>
        ...
        <nav className="border-gray-200 bg-white py-2.5 dark:bg-gray-900">
          <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between px-4">
            <Link href="/" className="flex items-center">
              <Logo className="mr-3 h-6 sm:h-9" height={36} />
            ...
            <div
              ...
              id="mobile-menu-2"
            >
              <ul className="mt-4 flex flex-col font-medium lg:mt-0 lg:flex-row lg:space-x-8"></ul>
            </div>
          </div>
        </nav>
      </header>
        ...
        <div className="mx-auto grid max-w-screen-xl px-4 pb-8 pt-20 lg:grid-cols-12 lg:gap-8 lg:py-16 lg:pt-28 xl:gap-0">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="mb-6 max-w-2xl font-light text-gray-500 dark:text-gray-400 md:text-lg lg:mb-8 lg:text-xl">
              ...
              sudah mencakup semua mulai dari tracking kerjaan, absensi,
              inventory, arsip, dan keuangan.
            </p>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="mx-auto flex w-full max-w-screen-xl items-center justify-center px-4 pb-8 lg:pb-16">
          {/* <div className="grid grid-cols-3 gap-10 text-gray-500 dark:text-gray-400">
            <Image
              src={HKTekno}
              width={94}
              height={100}
      ...
      <section className="bg-gray-50 dark:bg-gray-800">
        <div className="mx-auto max-w-screen-xl px-4 py-8 text-center lg:px-6 lg:py-24">
          <figure className="mx-auto max-w-screen-md">
            ...
            <blockquote>
              <p className="text-xl font-medium text-gray-900 dark:text-white md:text-2xl">{`"Landwind is just awesome. It
